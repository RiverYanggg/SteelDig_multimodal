...
## Samples
- paper_level: 97.33 (104 fields)
- sample_28mn0ni_hr: 98.33 (6 fields)
- sample_28mn0ni_hr_cr: 78.59 (31 fields)
- sample_28mn0ni_hr_cr_973: 86.78 (50 fields)
- sample_15mn5ni_hr_cr_1023: 89.07 (9 fields)
...
- sample_28mn5ni_hr_cr_973: 95.00 (8 fields)
...
- F00013 `papers.A3.paper_scope`: score=48.00, judge=partial, conf=0.80, refs=b0013
- F00014 `papers.A3.research_type`: score=9.00, judge=unknown, conf=0.30, refs=b0013
...
- F00017 `alloys.alloy_15mn5ni.aliases[1]`: score=54.00, judge=partial, conf=0.90, refs=b0018
...
- F00023 `alloys.alloy_15mn5ni.alloys_notes`: score=42.00, judge=partial, conf=0.70, refs=b0018,b0023
...
- F00036 `alloys.alloy_28mn0ni.aliases[1]`: score=100.00, judge=yes, conf=1.00, refs=b0018
...
- F00041 `alloys.alloy_28mn0ni.alloys_notes`: score=100.00, judge=yes, conf=1.00, refs=b0018
...
- F00052 `alloys.alloy_28mn5ni.aliases[1]`: score=100.00, judge=yes, conf=1.00, refs=b0018
...
- F00058 `alloys.alloy_28mn5ni.alloys_notes`: score=42.00, judge=partial, conf=0.70, refs=b0018,b0023
...
- F00070 `processes.proc_15mn5ni_hr.description`: score=100.00, judge=yes, conf=1.00, refs=b0021
- F00071 `processes.proc_15mn5ni_hr.processes_notes`: score=100.00, judge=yes, conf=1.00, refs=b0021,b0032
- F00072 `processes.proc_15mn5ni_hr_cr.description`: score=100.00, judge=yes, conf=1.00, refs=b0021
- F00073 `processes.proc_15mn5ni_hr_cr.processes_notes`: score=100.00, judge=yes, conf=1.00, refs=b0021
- F00074 `processes.proc_15mn5ni_hr_cr_1023.description`: score=100.00, judge=yes, conf=1.00, refs=b0021
- F00075 `processes.proc_15mn5ni_hr_cr_1073.description`: score=100.00, judge=yes, conf=1.00, refs=b0021
- F00076 `processes.proc_15mn5ni_hr_cr_1173.description`: score=100.00, judge=yes, conf=1.00, refs=b0021
- F00077 `processes.proc_15mn5ni_hr_cr_1273.description`: score=100.00, judge=yes, conf=1.00, refs=b0021
- F00078 `processes.proc_15mn5ni_hr_cr_873.description`: score=100.00, judge=yes, conf=1.00, refs=b0021
- F00079 `processes.proc_15mn5ni_hr_cr_973.description`: score=100.00, judge=yes, conf=1.00, refs=b0021
- F00080 `processes.proc_28mn0ni_hr.description`: score=100.00, judge=yes, conf=1.00, refs=b0021
...
- F00105 `processing_steps.sample_28mn0ni_hr.type`: score=100.00, judge=yes, conf=1.00, refs=b0021
...
- F00110 `processing_steps.sample_28mn0ni_hr_cr.sequence`: score=0.00, judge=unknown, conf=0.00, refs=-
- F00111 `processing_steps.sample_28mn0ni_hr_cr.temperature_with_unit`: score=48.00, judge=partial, conf=0.80, refs=b0013
- F00112 `processing_steps.sample_28mn0ni_hr_cr.type`: score=100.00, judge=yes, conf=1.00, refs=b0021,b0013
- F00120 `structures.sample_28mn0ni_hr_cr.microstructure_list[3].defects[planar_slip_bands].dislocation_density`: score=36.00, judge=partial, conf=0.60, refs=b0033,b0073
...
- F00122 `structures.sample_28mn0ni_hr_cr.microstructure_list[3].grain_structure.average_grain_size.value_with_unit`: score=36.00, judge=partial, conf=0.60, refs=b0032
- F00123 `structures.sample_28mn0ni_hr_cr.microstructure_list[3].grain_structure.texture`: score=36.00, judge=partial, conf=0.60, refs=b0032
- F00124 `structures.sample_28mn0ni_hr_cr.microstructure_list[3].phases_present[austenite].crystal_structure`: score=100.00, judge=yes, conf=1.00, refs=b0015,b0033
- F00125 `structures.sample_28mn0ni_hr_cr.microstructure_list[3].phases_present[austenite].grain_size`: score=36.00, judge=partial, conf=0.60, refs=b0032
...
- F00127 `structures.sample_28mn0ni_hr_cr.microstructure_list[3].phases_present[austenite].phase_name`: score=100.00, judge=yes, conf=1.00, refs=b0015,b0033
- F00128 `structures.sample_28mn0ni_hr_cr.microstructure_list[3].phases_present[austenite].texture`: score=0.00, judge=no, conf=0.30, refs=b0032
...
- F00130 `structures.sample_28mn0ni_hr_cr.microstructure_list[3].related_sequence`: score=0.00, judge=unknown, conf=0.00, refs=-
...
- F00187 `properties.sample_28mn0ni_hr_cr.mechanical.hardness[bulk].region`: score=100.00, judge=yes, conf=1.00, refs=b0028
- F00188 `properties.sample_28mn0ni_hr_cr.mechanical.hardness[bulk].scale`: score=100.00, judge=yes, conf=1.00, refs=b0028
- F00189 `properties.sample_28mn0ni_hr_cr.mechanical.hardness[bulk].value_with_unit`: score=100.00, judge=yes, conf=1.00, refs=b0118
...
- F00115 `processing_steps.sample_28mn0ni_hr_cr_973.method`: score=80.00, judge=yes, conf=0.80, refs=b0021,b0050
- F00116 `processing_steps.sample_28mn0ni_hr_cr_973.reduction_ratio`: score=100.00, judge=yes, conf=1.00, refs=b0021
- F00117 `processing_steps.sample_28mn0ni_hr_cr_973.sequence`: score=0.00, judge=unknown, conf=0.00, refs=-
- F00118 `processing_steps.sample_28mn0ni_hr_cr_973.temperature_with_unit`: score=90.00, judge=yes, conf=0.90, refs=b0021,b0050
...
- F00135 `structures.sample_28mn0ni_hr_cr_973.microstructure_list[4].phases_present[b2_intergranular].crystal_structure`: score=3.00, judge=unknown, conf=0.10, refs=b0037
...
- F00146 `structures.sample_28mn0ni_hr_cr_973.microstructure_list[4].phases_present[deformed].crystal_structure`: score=80.00, judge=yes, conf=0.80, refs=b0033,b0036
- F00147 `structures.sample_28mn0ni_hr_cr_973.microstructure_list[4].phases_present[deformed].morphology`: score=30.00, judge=partial, conf=0.50, refs=b0050
- F00148 `structures.sample_28mn0ni_hr_cr_973.microstructure_list[4].phases_present[deformed].phase_name`: score=90.00, judge=yes, conf=0.90, refs=b0069
...
- F00150 `structures.sample_28mn0ni_hr_cr_973.microstructure_list[4].phases_present[recrystallized].crystal_structure`: score=80.00, judge=yes, conf=0.80, refs=b0033,b0036
...
- F00152 `structures.sample_28mn0ni_hr_cr_973.microstructure_list[4].phases_present[recrystallized].morphology`: score=36.00, judge=partial, conf=0.60, refs=b0037,b0050
- F00153 `structures.sample_28mn0ni_hr_cr_973.microstructure_list[4].phases_present[recrystallized].phase_name`: score=90.00, judge=yes, conf=0.90, refs=b0050,b0058
...
- F00155 `structures.sample_28mn0ni_hr_cr_973.microstructure_list[4].precipitates[b2].distribution`: score=90.00, judge=yes, conf=0.90, refs=b0037,b0069
...
- F00161 `structures.sample_28mn0ni_hr_cr_973.microstructure_list[4].related_sequence`: score=0.00, judge=unknown, conf=0.00, refs=-
- F00162 `structures.sample_28mn0ni_hr_cr_973.number_of_phases`: score=30.00, judge=partial, conf=0.50, refs=b0036,b0050,b0069
- F00163 `structures.sample_28mn0ni_hr_cr_973.overall_structure`: score=100.00, judge=yes, conf=1.00, refs=b0050,b0058,b0067,b0069
...
- F00164 `interfaces.sample_15mn5ni_hr_cr_1023.defect_interaction[0].interaction_type`: score=90.00, judge=yes, conf=0.90, refs=b0142
- F00165 `interfaces.sample_15mn5ni_hr_cr_1023.defect_interaction[0].quality_description`: score=90.00, judge=yes, conf=0.90, refs=b0142
- F00166 `interfaces.sample_15mn5ni_hr_cr_1023.interface_notes[0].stress_strain_distribution`: score=90.00, judge=yes, conf=0.90, refs=b0142,b0167
- F00167 `interfaces.sample_15mn5ni_hr_cr_1023.phase_evolution`: score=90.00, judge=yes, conf=0.90, refs=b0142,b0167
- F00168 `interfaces.sample_15mn5ni_hr_cr_1023.phases[austenite].phase_1_name`: score=90.00, judge=yes, conf=0.90, refs=b0142
- F00169 `interfaces.sample_15mn5ni_hr_cr_1023.phases[austenite].phase_2_name`: score=90.00, judge=yes, conf=0.90, refs=b0142
- F00249 `characterization_methods.sample_15mn5ni_hr_cr_1023.key_findings`: score=90.00, judge=yes, conf=0.90, refs=b0142
- F00250 `characterization_methods.sample_15mn5ni_hr_cr_1023.purpose`: score=80.00, judge=yes, conf=0.80, refs=b0026,b0142
- F00251 `characterization_methods.sample_15mn5ni_hr_cr_1023.technique`: score=90.00, judge=yes, conf=0.90, refs=b0026,b0150

### sample_15mn5ni_hr_cr
- F00170 `properties.sample_15mn5ni_hr_cr.mechanical.hardness[bulk].region`: score=100.00, judge=yes, conf=1.00, refs=b0028,b0118
- F00171 `properties.sample_15mn5ni_hr_cr.mechanical.hardness[bulk].scale`: score=100.00, judge=yes, conf=1.00, refs=b0028
...
- F00202 `properties.sample_28mn0ni_hr_cr_1173.mechanical.hardness[bulk].scale`: score=100.00, judge=yes, conf=1.00, refs=b0028,b0121
...
- F00221 `properties.sample_28mn5ni_hr_cr.mechanical.hardness[bulk].value_with_unit`: score=100.00, judge=yes, conf=1.00, refs=b0073,b0118
...
- F00232 `properties.sample_28mn5ni_hr_cr_1173.mechanical.hardness[bulk].region`: score=100.00, judge=yes, conf=1.00, refs=b0028
- F00233 `properties.sample_28mn5ni_hr_cr_1173.mechanical.hardness[bulk].scale`: score=100.00, judge=yes, conf=1.00, refs=b0028
...
- F00241 `properties.sample_28mn5ni_hr_cr_973.mechanical.hardness[bulk].region`: score=95.00, judge=yes, conf=0.95, refs=b0028,b0121
- F00242 `properties.sample_28mn5ni_hr_cr_973.mechanical.hardness[bulk].scale`: score=95.00, judge=yes, conf=0.95, refs=b0028,b0121
- F00243 `properties.sample_28mn5ni_hr_cr_973.mechanical.hardness[bulk].value_with_unit`: score=95.00, judge=yes, conf=0.95, refs=b0121
- F00244 `properties.sample_28mn5ni_hr_cr_973.mechanical.tensile_properties.elongation[0].value_with_unit`: score=95.00, judge=yes, conf=0.95, refs=b0138
- F00245 `properties.sample_28mn5ni_hr_cr_973.mechanical.tensile_properties.ultimate_tensile_strength[0].others.uncertainty`: score=95.00, judge=yes, conf=0.95, refs=b0138
- F00246 `properties.sample_28mn5ni_hr_cr_973.mechanical.tensile_properties.ultimate_tensile_strength[0].value_with_unit`: score=95.00, judge=yes, conf=0.95, refs=b0138
- F00247 `properties.sample_28mn5ni_hr_cr_973.mechanical.tensile_properties.yield_strength[0].others.uncertainty`: score=95.00, judge=yes, conf=0.95, refs=b0138
- F00248 `properties.sample_28mn5ni_hr_cr_973.mechanical.tensile_properties.yield_strength[0].value_with_unit`: score=95.00, judge=yes, conf=0.95, refs=b0138
