...
a ArcelorMittal, R&D Packaging, Voie Romaine, BP 30320, 57283 Maizie\`res-le\`s-Metz Cedex, France b Ecole des Mines, Centre SMS, CNRS UMR 5146, 158 Cours Fauriel, 42023 St-Etienne Cedex 2, France c ArcelorMittal, R&D Automotive Products, Voie Romaine, BP 30320, 57283 Maizie\`res-le\`s-Metz Cedex, France
...
For all test conditions, the analyses were performed near the surface (0.9  radius). The observation plane is hz and the z-axis is parallel to the vertical direction in the electron backscatter diffraction (EBSD) maps. The microstructures were investigated by a scanning electron microscope (JEOL 6500) equipped with an EBSD system. HKL Channel 5 system software was used. Black lines and red lines are used for grain boundaries (misorientations $\theta \geqslant 1 5 ^ { \circ } )$ ) and subgrain boundaries $( 2 ^ { \circ } \leqslant \mathsf { \theta } < 1 5 ^ { \circ } )$ respectively. The arrows indicate the shear direction.
...
![](images/62b6c9c18c4156c76cdd925b77a65557135a9e84258ebb0141e2033d61143ebc.jpg)
...
![](images/d877e7754b6da9c08dd37ff17b90208dabdc9dd7e87501ef22d9ba9ae3290203.jpg)
D1△{112<11>
F {110}<001>
E1 (0lj<11>
D2口(112}<11>
...
Figure 3. {1 1 0} pole figures of the Fe–8% Al alloy deformed by torsion.
![](images/9ea736be854f2bc9c5404da17089e8ab8aba81d62c8f8ec30befb385d0c314dd.jpg)
...
![](images/e9d117ada7f235d9595daa2f0c7bfb78073754dd74fb99ec719639450843a81d.jpg)
...
![](images/c71b81ef6025269a9ed4597e0cafecbc57aaa4348d88da21c972631522169f0d.jpg)
...
![](images/3ae1f426e32a09f45dc10e0ae7c749c3cf3edefddcecef07ddc3d4cab8a9a0b2.jpg)
...
![](images/072a14131fbc07a66c4e8f71f2492d82103974de1f606d59d951f4cbd8ac3fbe.jpg)

<details>
<summary>scatter</summary>

| Temperature (°C) | DDRX not activated (s⁻¹) | DDRX activated (s⁻¹) |
| ---------------- | ------------------------ | -------------------- |
| 900              | 1.0                      | 10.0                 |
| 1000             | 0.5                      | 10.0                 |
| 1100             | 0.1                      | 10.0                 |
...
After considering the evolution of microstructures with strain, the resulting textures were analysed. A {1 1 0} pole figure displaying ideal orientations commonly observed during a torsion test for a body-centred cubic (bcc) alloy is given in Figure 3a [11]. The shear plane normal is {hkl} and the shear direction is <uvw>. Figure 3 displays {1 1 0} pole figures of the Fe–8% Al ferritic alloy deformed by torsion.
...
Several torsion tests were performed in the temperature range 900–1100 -C and strain rate range $0 . 1 { - } \mathrm { \dot { l } } 0 \mathrm { s } ^ { - 1 }$ in order to study the activation, or not, of the DDRX mechanism.
...
Last but not least, to limit the roping phenomenon, which is mainly attributed to the inhomogeneous orientation distribution of individual grains, it seems advantageous to favour a mechanism of DDRX during hot rolling in order to obtain a microstructure with randomly oriented recrystallized grains.
