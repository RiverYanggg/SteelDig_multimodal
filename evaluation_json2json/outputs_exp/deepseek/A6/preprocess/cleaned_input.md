...
![](images/97ec9338779f7f30b13d47c7c0296b65f5583ccfb6b59aff5db6b6da86f6091f.jpg)

Shao-bin Bai a,b , Yong-an Chen c , Xin Liu c , Hui-hu Lu d , Pei-kang Bai b , Da-zhao Li c,\* , Zhi-quan Huang b,\*\*, Jing-yang Li a
...
$$
\begin{array}{l} \alpha = 0. 3 5 7 2 1 + 0. 0 0 0 2 7 7 1 \omega (\mathrm{Al}) + 0. 0 0 4 4 0 8 9 \omega (\mathrm{C}) \\ + 0. 0 0 0 1 1 6 6 \omega (\mathrm{Mn}) \tag {2} \\ \end{array}
$$
...
![](images/f30f12d8401b3a122332671d04b78a86ddf51f0aac5955f4e1c90116c3acfe3a.jpg)
...
![](images/cfc5309481afa7d53a1c50ef5b1f977b99d30b08867aee8101efc0b92aedf2b3.jpg)

<details>
<summary>heatmap</summary>

| Region | Description              | Temperature (°C) Range |
|--------|--------------------------|------------------------|
| L      | L+δ                      | ~1400–1600             |
| L+γ    | L+γ                      | ~1300–1500             |
| E      | γ+κ+M3C                  | ~1200–1400             |
| γ+κ    | γ+κ+M3C                  | ~1000–1200             |
| γ+κ+K  | α(δ)+γ+κ                | ~900–1100              |
| S      | S                        | ~800–1000              |
| α+κ    | α+κ                      | ~600–800               |
| α+B2   | κ+B2                    | ~400–600               |
</details>
...
![](images/c957eb8f6aef001ee4abbc44df00b9106cc654623ff28e7a596469820759da19.jpg)
...
![](images/a99a71eebd8295b0b4be4ef96a91955798456a2f68f5af3595379382de6d7a84.jpg)

<details>
<summary>natural_image</summary>

Microscopic surface texture image showing layered structures with labeled regions (γ, α) and scale bar (4 μm), no textual content beyond labels.
</details>

![](images/13fc90666fea8a771880a74e3ea9a9ace54f66d230ba77aab5c2406bbf722d01.jpg)
...
![](images/2cc0957e1ed1f2425eb5a9dd6ef6491b90a8a28bbcc48bea7659099a5475c13f.jpg)
...
![](images/4fdd4069e2f609c36301cee40081136a7d7f06b12c2e29e27e27ecc5c85d710e.jpg)
...
![](images/d87f93fbef1900058fa15f52d13e2677b00a5f231312331dd0c52f165523417e.jpg)
...
| --------------- | ----------------------- |
| Solution        | 1100-1200 °C            |
| Hot rolling     | 1100-1200 °C            |
| Cold rolling    | 600-800 °C              |
| Annealing       | 600-800 °C              |
| Aging           | 450-700 °C              |
</details>
...
![](images/a7b25c27afef39849bcf2795f1a592ed829cc7e5d4ba9c5c366f3fb6b5bd7298.jpg)

<details>
<summary>line</summary>

| Element | Yield strength increment, MPa |
| ------- | ----------------------------- |
| N       | 200                           |
| C       | 160                           |
| Mo      | 120                           |
...
![](images/1cf069cab46eebf354c09158be82f31b14a12f30afbf0dee6f4cdfd00f7be189.jpg)

<details>
<summary>area</summary>

| Engineering strain, % | Engineering stress, MPa (d ≈ 1.12 µm) | Engineering stress, MPa (d ≈ 1.48 µm) | Engineering stress, MPa (d ≈ 1.75 µm) | Engineering stress, MPa (d ≈ 20.70 µm) |
| --------------------- | -------------------------------------- | -------------------------------------- | -------------------------------------- | -------------------------------------- |
| 0                     | ~1300                                  | ~1100                                  | ~900                                   | ~800                                   |
| 10                    | ~1350                                  | ~1150                                  | ~950                                   | ~850                                   |
| 20                    | ~1380                                  | ~1180                                  | ~980                                   | ~880                                   |
| 30                    | ~1390                                  | ~1200                                  | ~1000                                  | ~900                                   |
| 40                    | ~1380                                  | ~1180                                  | ~980                                   | ~880                                   |
| 50                    | ~1350                                  | ~1150                                  | ~950                                   | ~850                                   |
| 60                    | ~1300                                  | ~1100                                  | ~900                                   | ~800                                   |
</details>
...
The k-carbide has L0 12 ordered crystal structure similar to that of perovskite oxide, as shown in Fig. 6 [63]. The chemical formula of k-carbide is usually (Fe, Mn) AlC . Still, the exact chemical composition is unknown because the C content in ultrafine precipitates is challenging to measure. In 1995, Palm [64] reported that the chemical formula of k-carbide should be $( \mathrm { F e , \ M n ) _ { y } A l _ { 1 - y } C _ { x } \ ( - 0 . 2 \ < \ y < + 0 . 2 , \ 0 . 4 2 \ < \ x \ < \ 0 . 7 1 ) }$ through experiment and accurate calculation. Although the commonly used Fe AlC formula does not take into account the Fe/Al ratio deviation, it is still widely used. Seol et al. [42] proposed that the formation of k-carbide was determined by a eutectoid reaction related to nucleation and growth, which further revealed that the composition of k-carbide varied with the aging conditions and alloy composition.

High C (>0.7 wt%) and Al (>7.0 wt) contents are the primary conditions for k-carbide formation in single austenite-base FeeMneAleC steels. However, k-carbide can be divided into k0 -carbide and k\* -carbide according to the aging temperature. When the aging temperature ranges from 500 to $7 0 0 ^ { \circ } \mathrm { C } ,$ the spinodal decomposition will occur in austenite, which is described as follows: $\gamma \to \gamma ^ { \prime } + \gamma " \to \gamma " + \mathrm { L } 1 _ { 2 }$ (short-range ordering phase) /g'þk' [65]. Meanwhile, the k0 -carbide refers to the ultrafine precipitate nucleated within the austenite matrix (Fig. 6), showing a coherent relationship between them [29,42,61]. Finally, the ultrafine layer k0 -carbide in austenite and nano dispersed k0 -carbide in ferrite can significantly enhance yield stress and cause aging hardening [66,67]. As the aging temperature increases to $7 0 0 { - } 9 0 0 \ ^ { \circ } \mathrm { C } ,$ the coarse $\kappa ^ { \prime } -$ carbide will generate in austenite matrix or along the prior austenite grain boundary. This k0 -carbide is called intercrystalline k\* -carbide. Therefore, the high aging temperature can accelerate the precipitation of coarse k\* -carbide along the grain boundary. Moreover, the long aging time will lead to the formation of brittle b-Mn phase. However, k\* -carbide and $\beta -$ Mn are unfavorable to the ductility and toughness of FeeMneAleC low-density steels [68]. Therefore, the aging temperature and time should be precisely regulated to avoid the formations of intergranular k\* -carbide and b-Mn in single austenite-base FeeMneAleC steel. Under a plastic deformation, the interaction between k-carbides and dislocations does not change the plane slip mode, but the additional dislocation sources are activated and acted upon by cross slip [38]. Moreover, these nano k-carbides uniformly distribute in austenite and then promote the plane slip. As the strain increases, the plane dislocation structure is further refined, contributing to continuous strain hardening. This is the main contribution of k-carbide strengthening in single austenitebase FeeMneAleC steels.

# (2) B2 phase strengthening

![](images/8ceeabf1b1de52e1ffd5a921797a1a65cf5ca2ac294a01a8b19715339f3bf727.jpg)

<details>
<summary>chemical</summary>

Crystal structure diagram of (Fe, Mn)Al-type B2 phase showing Fe/Mn and C atoms with color-coded positions
</details>

![](images/a6691d45cbb509cbf7e22db48836adb1c11995db37ce28bf417ec2edbd68023b.jpg)
...
![](images/c4f2a81d8b4a40e0ac723afb2e540e23efd60f38069cc0497d2ec5a0cd3c48be.jpg)
...
![](images/d5b1ef7bb3f0c6c53fdbf0173c15e9186a0ae7728e46ae7382f99a967ae660a5.jpg)
...
![](images/89c817833218e625ede6d993961640abadb562f25d55391ac44393130774757c.jpg)

<details>
<summary>contour</summary>

| Material              | Al content (wt.%) | C content (wt.%) |
|-----------------------|-------------------|------------------|
| MBIP + Kappa          | ~10               | ~0.8             |
| KBAP-Carbide forming border | ~10               | ~0.6             |
| KBAP-Carbide forming border | ~15               | ~0.4             |
| KBAP-Carbide forming border | ~20               | ~0.2             |
| KBAP-Carbide forming border | ~25               | ~0.1             |
| KBAP-Carbide forming border | ~30               | ~0.05            |
| KBAP-Carbide forming border | ~35               | ~0.02            |
| TWIP                  | ~8                | ~0.7             |
| TWIP+Kappa            | ~8                | ~0.6             |
| TWIP                   | ~10               | ~0.5             |
| TWIP                   | ~15               | ~0.4             |
...
| TRIP                  | ~140              | ~0.00000002      |
| TRIP                  | ~145              | ~0.00000001      |
| TRIP                  | ~150              | ~0.000000005     |
| TRIP                  | ~155              | ~0.000000002     |
| TRIP                  | ~160              | ~0.000000001     |
| TRIP                  | ~165              | ~0.0000000005    |
| TRIP                  | ~170              | ~0.0000000002    |
| TRIP                  | ~175              | ~0.0000000001    |
| TRIP                  | ~180              | ~0.00000000005   |
| TRIP                  | ~185              | ~-0.1            |
| TRIP                  | ~190              | --0.2            |
| TRIP                  | ~195              | --0.3            |
| TRIP                  | ~200              | --0.4            |
| TRIP                  | ~205              | --1.2            |
| TRIP                  | ~210              | -                 |
The chart displays three-dimensional contour plots (color-coded by value) for different materials.
</details>
...
![](images/f905e3f081c8df739a24dc6563f005aadbaacf525d17c1ae31b69796bff76b6f.jpg)
...
![](images/ed11d6b243df85322052d1c51792f6e8513280d806852b0fe7a144ff82aebf3e.jpg)
...
![](images/6c0aca18841265bf9fcb409e690565ac04afc4ee5295fc5592901c863f0d5a1f.jpg)

<details>
<summary>natural_image</summary>

Microscopic image showing a textured surface with yellow dashed lines and a 50 nm scale bar (no readable text or symbols)
</details>

![](images/9342cc3869c40b3d486d46a9b1810a5780d4b7c7167893d6696eb68672ffbb87.jpg)
...
![](images/db9bf83a872b27c4b17b7eb18c11b8053388162bb522c429afa67e969eb0a77a.jpg)
...
![](images/7825d52fb7b3b36c567877b8024b917c1b0d6e7118460235973394ae10632774.jpg)
...
![](images/92d5c01035183308fc8d3c2df40266e00504c57f725d36b29643e3801ff0ed84.jpg)

<details>
<summary>natural_image</summary>

Microscopic image of a material surface showing grain structure with scale bars (0.5 μm and 0.2 μm), no readable text or symbols present.
</details>

![](images/a2e82f90814cb36ab81a3fc6f142bce4e6857c0d44ce4b409301f8374c14d0b1.jpg)
...
![](images/137ab00388d027bed9c3d95577d77a2649d814a10599eb11ad41c3db9be1a12f.jpg)
...
![](images/fe1227ba5c09c1cbf4c97ac236c469246ec892fe60a12141977a1c29f94b3d20.jpg)
...
![](images/5a2ca398621b3e4fca8ac7ddacbdc6da5d8d860f0794b3a4f4d759904649aced.jpg)

<details>
<summary>natural_image</summary>

Microscopic image showing a textured surface with scale bar indicating 1 μm, labeled (e) 5% (no other text or symbols)
</details>

![](images/ac4eb470735747aa2356764a4cbce0bf751a25a9383f68f5a81ace2ce6b63892.jpg)

<details>
<summary>natural_image</summary>

Microscopic image showing granular texture with scale bar indicating 1 μm (no text or symbols present)
</details>
...
![](images/6ea0af1b90c6f2f93c9dec0f2389d9a43513e5d271499d66156331bb77539492.jpg)
...
![](images/46021bef8ca6d75387dcf82998b5c71797b9446dc2e3a2918002be03eaaa4300.jpg)
...
![](images/247e3602e7298d28d889d2d1675cd22a78c865731c870b7a9c4d81023c02457e.jpg)
...
![](images/039a680314f46ab851d0457977a319c56183c48880de4a96f8eed13aad55d854.jpg)
...
![](images/7b7bdc15d91d8b34325cda3bf68843a1aa4168ba06fde5ad7e4daf8f3be3b148.jpg)

<details>
<summary>line</summary>

| True strain | Strain hardening rate, MPa | True stress, MPa |
| ----------- | -------------------------- | ---------------- |
| 0.00        | 0                          | 0                |
| 0.05        | 2500                       | 1000             |
| 0.10        | 1800                       | 1200             |
...
![](images/16b52e43bdb1021e0680f0b7f012a8d517ab3b318fb79f66cdcbd427e91f7d0f.jpg)
...
![](images/1ed9e4696107405235e769b040556c84a80cbeaedb21ada714221f481be1da34.jpg)

<details>
<summary>natural_image</summary>

Two diffraction patterns labeled Z=[111] and Z=[011], each with 5 1/nm scale bar (no text or symbols beyond labels)
</details>

![](images/9eb4ed5f872a2548af78fddb0e403f37b40efb8d63754e3ba6e7f930a3cc65d4.jpg)

<details>
<summary>natural_image</summary>

Microscopic image showing granular texture with 200 nm scale bar (no text or symbols beyond label)
</details>

![](images/b517ff497ecb298bab28186d0fae800ac5c7178e72a1e750a5d19fc86654a35a.jpg)

<details>
<summary>natural_image</summary>

Microscopic image of a crystal structure with 200 nm scale bar, showing internal grain boundaries and an inset 3D cube (no text or symbols)
</details>

![](images/6cd0d161016b93cb48ec2228738b124856102ead459fc75a2be5b4c31dca2db5.jpg)

<details>
<summary>natural_image</summary>

Microscopic image of a material surface with a 200 nm scale bar, showing granular texture and a dashed-line defect (no text or symbols beyond label)
</details>

![](images/72a998697869b6b775d940bebb65c56d39c8b87985637573b268fb6a69ab09c6.jpg)
...
Fig. 12 e Strain hardening rate curve (a) and the corresponding strengthening mechanism (bef) of Fee3.9Mne5.8Ale0.35C F-BDP steel under different tensile strains [15]. (bed) Straining at 10%; (e, f) Straining at 20%.

![](images/4e97fc8cf1ba431720adadf5b378e5a07a3fc897c89e6d2b29d637062e3aa097.jpg)

<details>
<summary>line</summary>

| Mn content, wt.% | 0 °C | -196 °C |
|---|---|---|
| 17 | 230 | 45 |
| 19 | 255 | 130 |
| 22 | 255 | 150 |
...
![](images/9857674a07c8faea95597215d6989e1512123288a3975b8cbc425faba61959a5.jpg)

<details>
<summary>line</summary>

| Al content, wt.% | Charpy impact absorbed energy, J |
| ---------------- | -------------------------------- |
| 3                | 120                              |
| 5                | 135                              |
| 8                | 15                               |
...
![](images/d49db08f09adfe74f07406f560cfda4a092a0548394aa1cce5d04b0f668e1159.jpg)
...
![](images/e17384b612f5ea236781c50b1fa3b2ed530281c36df77cfa80bbc2833fecbe51.jpg)
...
![](images/be9d7c30df878d6c7d20f71b7f8b30385a56b41c8b2c6bdc0d643adc2ca6af81.jpg)

<details>
<summary>line</summary>

| Testing temperature, °C | Austenite stainless steel | Ferrite steel | Martensite steel | Dual phase steel |
| ----------------------- | ------------------------- | ------------- | ---------------- | ----------------- |
| -200                    | 70                        | 0             | 0                | 0                 |
| -150                    | 140                       | 0             | 0                | 0                 |
| -100                    | 160                       | 0             | 0                | 0                 |
...
![](images/64f1f67073b3e8d97adddb72d0b0b046cbbded88364a52f9cb2825586c746526.jpg)

<details>
<summary>line</summary>

| Al content, wt.% | Impact toughness, J/cm² (Solid Line) | Impact toughness, J/cm² (Dashed Line) |
| ---------------- | ------------------------------------ | ------------------------------------- |
| 3                | 50                                   | 100                                   |
| 4                | 100                                  | 150                                   |
| 5                | 130                                  | 180                                   |
...
Impact toughness is one of the essential properties for evaluating automotive steels, representing the ability to absorb plastic deformation and fracture energies under impact loading. The impact toughness of FeeMneAleC steels depends on the phase composition and its distribution, especially the k-carbide precipitation and d-ferrite formation [104].
...
![](images/d4615e65df19586e9bbe200151128d83a134f874356ef5625e87c70d2a2ba524.jpg)
...
![](images/4262c1011b8962c045c32a284040dc39486844b7f918632d575ff443fb49ab8b.jpg)
...
![](images/37504c2dd91bd0f89a903903bc6b78a0746b39f2b1e63e0ba8874806cd5ef00b.jpg)
...
![](images/a2bdb1a470562f07c596105987d60c61644e907be27b66675c925b478b46cf8f.jpg)
...
![](images/72e31f1e9f4fb06f1f8d26d36812410f307daeb48a02bf2cae3c4054884cb7d9.jpg)
...
![](images/66b5670b97b3b2eb00880da025f4532d70debc2784876d8528dbaea7346beedc.jpg)
...
![](images/fa0a5f4d6d35b5c3d05505867b077a657caf31ec678f333c12ebb7058688d574.jpg)
...
![](images/3798f4b69f7c94fb2163ab8fcb41bdf5d7a6065bcaeca732182cfb860d713e5b.jpg)
...
Grain boundary
5 µm
Mag= 5.10 kX WD=7.0 mm EHT=15.00 kV Signal A=QBSD Date: 26 Feb 2013
</details>
...
![](images/f160aa01d9d61a2b8a2e9b3242e5ced8be6dfbe18ff764a5bf2216c9cb0a5b90.jpg)
...
dislocation walls
High density
dislocation tangles 0.5 µm
</details>

![](images/8bf2976395eec0b77fc2aacb98050073439bc9d467c68eae3840832b235bf1ac.jpg)
...
![](images/8dac27f0d665cfaaba0e14558aa96cc05db61a01e54ba86d6aa072022d416084.jpg)

<details>
<summary>bar</summary>

(e)
| Process | Wear resistance/g⁻¹ |
|---|---|
| as quenched | 1.16 |
| +550°C(1h) | 1.66 |
| +550°C(2h) | 2.66 |
...
![](images/6cd96bd20d0db73da1f971b03cbcaffcca8d0a860a03ee58b1ee721dc342feab.jpg)
...
(1) Alloy design. The variations of Mn, Al, and C contents lead to the difference of phase constituents in FeeMneAleC low-density steels and a wide range of tensile properties can be acquired. Still, Al addition can achieve the weight saving and microstructure
...
[15] Liu M, Song C, Cui Z. Crystallographic texture evolution and martensite transformation in the strain hardening process of a ferrite-based low density steel. J Mater Sci Technol 2021;78:247e59.
...
[21] Khaple S, Prakash U, Golla BR, Prasad VVS. Effect of niobium addition on microstructure and mechanical properties of Fe-7Al-0.35C low-density steel. Metallogr Microstruct Anal 2020;9:127e39.
...
[28] Shao CW, Zhang P, Liu R, Zhang ZJ, Pang JC, Duan QQ, Zhang ZF. A remarkable improvement of low-cycle fatigue resistance of high-Mn austenitic TWIP alloys with similar tensile properties: importance of slip mode. Acta Mater 2016;118:196e212.
[29] Zambrano OA. A general perspective of Fe-Mn-Al-C steels. J Mater Sci 2018;53:14003e62.
[30] Eskandari M, Zarei-Hanzaki A, Kamali A, Mohtadi-Bonab M, Szpunar J. Strain hardening during hot compression through planar dislocation and twin-like structure in a lowdensity high-Mn steel. J Mater Eng Perform 2014;23: 3567e76.
[31] Schneider A, Falat L, Sauthoff G, Frommeyer G. Microstructures and mechanical properties of Fe3Al-based Fe-Al-C alloys. Intermetallics 2005;13:1322e31.
...
[39] Bartlett L, Aken DV. The effect of silicon content on the dynamic fracture toughness of high manganese and aluminum steels. JOM 2014;66:1770e84.
[40] Cheng WC. Phase transformations of a Fe-0.85C-17.9Mn-7.1Al austenitic steel after quenching and annealing. JOM 2014;66:1809e20.
...
[50] Chen XP, Xu YP, Ren P, Li WJ, Cao WQ, Liu Q. Aging hardening response and b-Mn transformation behavior of high carbon high manganese austenitic low-density Fe-30Mn-10Al-2C steel. Mater Sci Eng A 2017;17:30949.
...
[55] Kwang KK, Hyo JB, Eun HP, Hyeon J, Hyong SP, Jae SJ, Jung GK, Hyokyung S, Nokeun P, Jae BS. A feasible route to produce 1.1 GPa ferritic-based low-Mn lightweight steels with ductility of 47%. J Mater Sci Technol 2022;117:225e37.
...
[58] Gwon H, Kim JK, Shin S. The effect of vanadium microalloying on the microstructure and the tensile behavior of TWIP steel. Mater Sci Eng A 2017;696:416e21.
...
[60] Song WW, Dronskowski R, Bleck W. k-phase formation in Fe-Mn-Al-C austenitic steels. Steel Res Int 2015;86:1161e9.
[61] Cheng WC, Cheng CY, Hsu CW. Phase transformation of the L1 to kappa-carbide after spinodal decomposition and ordering in an Fe-C-Mn-Al austenitic steel. Mater Sci Eng A 2015;642:128e35.
...
[69] Sundman B, Ohnuma I, Dupin N. An assessment of the entire Al-Fe system including DO3 ordering. Acta Mater 2009;57:2896e908.
...
[74] Sohn SS, Lee BJ, Lee S. Effect of annealing temperature on microstructural modification and tensile properties in 0.35C-3.5Mn-5.8Al lightweight steel. Acta Mater 2013;61:5050e66.
...
[88] Welsch E, Ponge D, Haghighat SM, Sandloebes S, Choi P, Herbig M. Strain hardening by dynamic slip band refinement in a high-Mn lightweight steel. Acta Mater 2016:188e99.
...
[95] Zhao Y, Songa BY, Pei JY, Jiaa CB, Li B, Guo LL. Effect of deformation speed on the microstructure and mechanical properties of AA6063 during continuous extrusion process. J Mater Process Technol 2013;213:1855e63.
...
[107] Kalashnikov I, Acselrad O, Pereira LC, Kalichak T. Behavior of Fe-Mn-Al-C steels during cyclic tests. J Mater Eng Perform 2000;9:334e7.
...
[114] Rao VS. Some observations on the hydrogen embrittlement of Fe3Al-Fe3AlC intermetallic compounds. Mater Res Bull 2004;39:169e74.
...
[126] He W, Wang BL, Yang Y, Zhang YH, Duan L, Luo ZP, Song CJ, Zhai QJ. Microstructure and mechanical behavior of a lowdensity Fe-12Mn-9Al-1.2C steel prepared using centrifugal casting under near-rapid solidification. J Iron Steel Res Int 2018;25:830e8.
...
[150] Lee SI, Lee SW, Kim SG, Hwang B. Correlation of delta-ferrite with tensile and Charpy impact properties of austenitic Fe-23Mn-Al-C steels. Metall Mater Trans 2021;52:4170e80.
