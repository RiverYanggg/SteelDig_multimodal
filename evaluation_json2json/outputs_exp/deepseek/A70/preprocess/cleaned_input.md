...
In order to reduce energy consumption and greenhouse gas emissions in the next generation automobiles, there is an increasing demand for the development of advanced high-strength steels with high strength to weight ratio1,2 . With excellent mechanical properties3–8 , Fe-Mn-Al-C low-density steels are promising candidates for such applications. Tese steels were originally designed to replace the stainless steels because of their good oxidation and corrosion resistance but recently they have regained interest because of the signifcant reduction in mass density due to alloying with Al, and are therefore considered as promising candidate materials for an automotive body in white3,5 .

Teir success depends on the design of the alloy composition and processing route to enhance the precipitation of various ordered nano-sized particles. Depending on the Al content, various types of ordered structures can form in the microstructure of low-density steels, i.e. B2, L12, L1′ , etc. B2 has a bcc structure where the Fe (Ni) atoms are positioned at the corners of the unit cell and the Al atom occupies the central position. L1′ is a perovskite structure with the Fe AlC formula that is commonly denoted as a κ-carbide phase. Te addition of Mn into this carbide structure leads to the formation of Fe MnAlC, FeMn AlC and Mn AlC phases. Tese phases have a structure similar to the ordered fcc phase, Fe $_ { 3 } \mathrm { A l } \mathrm { - L } 1 _ { 2 } ,$ wherein the Fe atoms are located at the centre of each face and the Al atoms at the corners of the unit cell. Te additional carbon atom to this structure results in L1′2 where carbon occupies the central octahedral interstitial position formed by the six Fe atoms as its nearest neighbours. Tese precipitates are formed by the ordering of alloying elements such as C, Mn, and Al9–11.

1AI Manufacturing Solutions, 1 Sandover House, 124 Spa Road, London, SE16 3FD, United Kingdom. 2Advanced Steel Research Centre, WMG, University of Warwick, Coventry, CV4 7AL, United Kingdom. 3School of Materials, University of Manchester, Manchester, M13 9PL, United Kingdom. 4Institute for Future Transport and Cities, Coventry University, Coventry, CV1 5FB, United Kingdom. 5George S. Ansell Department of Metallurgical and Materials Engineering, Colorado School of Mines, Golden CO, 80401, USA. Correspondence and requests for materials should be addressed to A.R. (email: alirezarahnama@ymail.com)

![](images/c7ed91982e2803595bda2c5bbd68728e52a87b0f8e32b221418dbb6c0dad1213.jpg)

<details>
<summary>text_image</summary>

Micro-scale
B2 Stringer band @ 700°C and 500°C
γ + κ (nano,
+ B2 (micro)
GB B2
α + B2 (nano)
